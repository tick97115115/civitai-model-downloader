...
import { model_id, models_response } from "@shared/types/models_endpoint";
import { ModelId, ModelsResponse } from "@shared/types/models_endpoint";

const models_res = JSON.parse(`{
    "items": [
        {
            "id": 11821,
...
describe("test layout class", () => {
  const modelId1 = (models_response(models_res) as ModelsResponse).items[0];
